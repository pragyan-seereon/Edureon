...
// //         // Both endpoints return the raw parsed body: { success, data: [...] }
...
// //       try {
// //         // getSections mirrors getClasses/getAdmissionSources — it returns
// //         // the raw parsed body { success, data: [...] }, so only one
// //         // `.data` unwrap is needed here (previously this double-unwrapped
// //         // with `.data?.data`, which silently emptied the Section list).
// //         const response = await getSections(d.class_uuid);
// //         if (!cancelled) setSections(response?.data ?? []);
// //       } catch (error) {
// //         console.log(error);
// //         if (!cancelled) {
