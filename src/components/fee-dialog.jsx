...
//   SelectValue,
// } from "./ui/select";
// import { collectOfflineFee,getMonthlyDue } from "../api/payment";

// import { toast } from "sonner";

// export function FeeDialog({ open, onOpenChange, txn,  students,
//   structures, }) {
...
//       fee_structure_uuid: txn.fee_structure_uuid || "",

//       fee_month: txn.fee_month || "",

//       monthly_fee: Number(txn.monthly_fee || 0),

//       late_fee: Number(txn.late_fee || 0),

//       total_amount: Number(txn.total_amount || 0),

//       payment_mode: txn.payment_mode || "OFFLINE",

//       due_uuids: txn.due_uuids || [],
...
//     if (!f.fee_month)
//       return toast.error("Fee month is required.");
...
//       value={f.class_name}
//       onChange={(e) =>
//         setF({ ...f, class_name: e.target.value })
//       }
//     />
//   </Field>
